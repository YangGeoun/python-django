...
def solved(request, user_pk):
    ...
    graph_list = [class_dic.setdefault('자료 구조',0),
                  class_dic.setdefault('다이나믹 프로그래밍',0),
                  class_dic.setdefault('그리디 알고리즘',0),
                  class_dic.setdefault('브루트포스 알고리즘',0),
                  class_dic.setdefault('그래프 이론',0),
                  class_dic.setdefault('문자열',0)]
#
    print(graph_list)
# 
    context = {
